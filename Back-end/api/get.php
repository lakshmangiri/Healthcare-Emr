...
$sql = "INSERT INTO mail (name, email, stored_time) VALUES ('$name', '$email', CURRENT_TIMESTAMP)";
    ...
    <body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly;">
        ...
        <div style="max-width: 300px; margin: 0 auto;" class="email-container">
           ...
           <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="50%">
                                <tr>
                                    <th style="border-radius:1px solid black;text-align: center;padding: 0px;font-weight:bold;font-family: sans-serif;font-size: 12px;line-height: 25px;color: #fff;margin:auto;">
                                       ...
                                       <p style="font-weight: normal;">Thank you for joining the platform</p>
                                       <p>your Email id is : some@abc.com</p>
                                       <p>your password is : some </p>
                                    </th>
                                </tr>
                            </table>
			...
			echo "Thank you " .$name. " for joining the community. We have sent a confirmation mail, please do check.";
